import { STATUS_ABORTED, STATUS_NOT_FOUND, STATUS_PENDING, STATUS_REJECTED, STATUS_RESOLVED } from "./constants.js";
...
export type Status = StatusNotFound | StatusPending | StatusAborted | StatusRejected | StatusResolved;
...
export type RecordData<Type> = PendingRecordData<Type> | ResolvedRecordData<Type> | RejectedRecordData;
...
export type SubscriptionData<Type> = SubscriptionDataNotFound | SubscriptionDataPending | SubscriptionDataAborted | SubscriptionDataRejected | SubscriptionDataResolved<Type>;
...
export type IntervalCache<Point, Params extends any[], Value> = {
    ...
    getValueIfCached(start: Point, end: Point, ...params: Params): Value[] | undefined;
    readAsync(start: Point, end: Point, ...params: Params): PromiseLike<Value[]> | Value[];
    isPartialResult: (value: Value[]) => boolean;
    read(start: Point, end: Point, ...params: Params): Value[];
    subscribe(callback: SubscriptionCallback<Value[]>, start: Point, end: Point, ...params: Params): UnsubscribeCallback;
};
...
export interface StreamingCache<Params extends any[], Value, AdditionalData = undefined> {
    abort(...params: Params): boolean;
    disableDebugLogging(): void;
    enableDebugLogging(): void;
    evict(...params: Params): boolean;
    evictAll(): boolean;
    prefetch(...params: Params): void;
    read(...params: Params): Pick<StreamingValue<Value, AdditionalData>, "data" | "value">;
    readAsync(...params: Params): PromiseLike<Pick<StreamingValue<Value, AdditionalData>, "data" | "value">>;
...
export type ExternallyManagedCache<Params extends any[], Value> = Omit<Cache<Params, Value>, "cache"> & {
...
export type ImperativeIntervalPendingResponse<Value> = ImperativePendingResponse<Value>;
export type ImperativeIntervalResolvedResponse<Value> = ImperativeResolvedResponse<Value> & {
